use memecoin_staking::memecoin_staking::interface::Events;
...
pub fn validate_new_stake_event(
    spied_event: @(ContractAddress, Event), staker_address: ContractAddress, stake_index: Index,
) {
    let expected_event = Events::NewStake { staker_address, stake_index };
...
pub fn validate_claimed_rewards_event(
    ...
    let expected_event = Events::ClaimedRewards { staker_address, stake_index, rewards };
    assert_expected_event_emitted(
        spied_event: spied_event,
        :expected_event,
...
pub fn validate_stake_unstaked_event(
    ...
    let expected_event = Events::StakeUnstaked { staker_address, stake_index };
    assert_expected_event_emitted(
        spied_event: spied_event,
        :expected_event,
