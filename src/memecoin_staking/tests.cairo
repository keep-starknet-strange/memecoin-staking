use memecoin_staking::memecoin_staking::event_test_utils::validate_stake_event;
...
fn test_stake() {
    ...
    let spied_event = spy.get_events().emitted_by(contract_address: cfg.staking_contract).events[0];
    validate_stake_event(:spied_event, :staker_address, :stake_duration, :stake_index);
}
