...
fn test_stake() {
    ...
    cheat_caller_address_once(contract_address: token_address, caller_address: cfg.owner);
    ...
    cheat_and_approve(
        :token_address, approver: cfg.staker_address, spender: cfg.staking_contract, amount: amount,
    );
